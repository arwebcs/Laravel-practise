                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="student_name" id="student_name" placeholder="John Doe" value="{{ $data->full_name }} " />
                                <div id="defaultFormControlHelp" class="form-text text-danger">
                                    @error("student_name"){{ $message }}@enderror
                                </div>
                                <label for="defaultFormControlInput" class="form-label">DOB</label>
                                <input type="date" class="form-control" name="student_dob" id="student_dob" value=" {{ $data->dob }} " />
                                <div id="defaultFormControlHelp" class="form-text text-danger">
